...
<AUTOSAR xmlns="http://autosar.org/schema/r4.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://autosar.org/schema/r4.0 AUTOSAR_4-4-0.xsd">
    <AR-PACKAGES>
        <AR-PACKAGE>
            ...
            <LONG-NAME>Sample ARXML Package</LONG-NAME>
            <ELEMENTS>
                <ECU-INSTANCE>
                    ...
                    <PROPERTY-VALUES>
                        <PROPERTY-VALUE>
                            <DEFINITION-REF DEST="PROPERTY-DEFINITION">/AUTOSAR/System/ECUInstance/ECUInstanceType</DEFINITION-REF>
                            <VALUE>ECU</VALUE>
                        </PROPERTY-VALUE>
                    </PROPERTY-VALUES>
                </ECU-INSTANCE>
                <SYSTEM>
                    <SHORT-NAME>SampleSystem</SHORT-NAME>
                    <LONG-NAME>Sample System</LONG-NAME>
                    <ECU-INSTANCES>
                        <ECU-INSTANCE-REF DEST="ECU-INSTANCE">/SamplePackage/SampleECU</ECU-INSTANCE-REF>
                    </ECU-INSTANCES>
                </SYSTEM>
            </ELEMENTS>
        </AR-PACKAGE>
    ...
    def on_tree_select(self, event):
        ...
        if selection:
            item = selection[0]
            # You could implement navigation to the selected element here
    ...
    def show_tree_view(self):
        """Show only tree view"""
        # Implementation for tree-only view
        self.status_var.set("Tree view mode")
    
    def show_text_view(self):
        """Show only text view"""
        # Implementation for text-only view
